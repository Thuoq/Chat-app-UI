  ...
  >
    <div class="flex-none min-w-[260px]" v-if="window.width > 1024">
      <Card bodyClass=" relative p-0 h-full overflow-hidden ">
        ...
        <div class="contact">
          <div
            class="border-b border-slate-100 dark:border-slate-700 py-1 mb-1"
          >
            <div
              class="search px-3 mb-3 mx-6 rounded flex items-center space-x-3 rtl:space-x-reverse"
            >
              <div
                class="flex-none text-base text-slate-900 dark:text-slate-400"
              >
    ...
    <Transition @enter="enterMobileSidebar" @leave="leaveMobileSidebar">
      <mobile-sidebar v-if="window.width <= 1024 && this.mobileChatSidebar" />
    </Transition>
    ...
    <div class="flex-1">
      <div class="parent flex space-x-5 h-full rtl:space-x-reverse">
        <div
          class=""
          :class="
            this.openinfo && this.activechat === true ? 'flex-1' : 'flex-1'
          "
        >
        ...
        <div
          ...
          v-if="
            this.openinfo && this.activechat === true && window.width > 1280
          "
        >
...
export default {
  ...
  computed: {
    ...mapWritableState(useChatStore, ["searchContact", "openinfo"]),
    ...mapWritableState(useContactStore, ["activechat", "mobileChatSidebar"]),
